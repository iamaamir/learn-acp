...
- 0007 built (2026-09-08): clinic 01 slash commands (advertise/validate/fire-as-prompt), specials-board Canvas + order sandbox hybrid, src/acp-commands.mjs. Clinic queue: terminals next.
...
- HISTORY 2026-09-08: PNGs were in 3 old commits → purged via filter-branch + force-push. Tree verified PNG-free. README added (live link, local run/test, layout, method).
